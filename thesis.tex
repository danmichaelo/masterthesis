...
\begin{figure}[htbp]
  ...
  %    -339.349832 eV
  % 2) test_structures/tetrahedral/accurate3
  %    -348.636614 eV
  \subfloat[Tetrahedral]{
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/tetrahedral/accurate3/vmd_detail2.png}
    \label{fig:silicon_with_p_interstitial_tetrahedral}
  }
  % 1) test_structures/hexagonal/01-relax
  %    -340.418075 eV
  % 2) test_structures/hexagonal/01-relax/accurate
  %    KJØRER
  \subfloat[Hexagonal]{
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/hexagonal/01-relax/vmd_detail2.png}
    \label{fig:silicon_with_p_hexagonal.png}
  }\\
  % 1) split-110-from-md/relax_frame4493
  %    -340.627774 eV
  % 2) test_structures/split-110-from-md/accurate
  %    KJØRER
  \subfloat[Split $\langle110\rangle$]{
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/split-110-from-md/vmd_detail2.png}
    \label{fig:silicon_with_p_split110w.png}
  }
  % 1) test_structures/bond-centered-111
  %    KRÆSJA
  % 2) test_structures/bond-centered-111/accurate
  %    -344.934249 eV
  \subfloat[Bond-centred $\langle111\rangle$]{
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/bond-centered-111/accurate/vmd_detail5.png}
    \label{fig:silicon_with_p_interstitial_bc111}
  }
