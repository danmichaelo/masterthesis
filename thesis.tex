...
\begin{figure}[htp]
  \centering
  \includegraphics[width=6cm]{../notur/hipersol/si-pi/si64/split110_1000/relax_frame4493/supercell/vmdscene3.png}
  \includegraphics[width=7.5cm]{../notur/hipersol/si-pi/si64/split110_1000/relax_frame4493/supercell/plot_radial_displacement.pdf}
  \caption{Effect of a split~$\langle 110 \rangle$ Si-P pair in a $6\times 6\times 6$ cubic diamond unit cell (side length 32.8~Å). The blue cube is the $6\times 6\times 6$ cell (side length 10.94~Å) used in the simulations.}
  \label{fig:peffect}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \subfloat[Tetrahedral, -1.188 eV]{
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/tetrahedral/stdrelax-short/vmd_detail2.png}
  ...
  \subfloat[Hexagonal, -2.136 eV]{
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/hexagonal/stdrelax/vmd_detail.png}
    \label{fig:hexagonal}
  }
  %
  ...
  \subfloat[Bond-centred $\langle111\rangle$, -0.883 eV]{
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/bond-centered-111/stdrelax/vmd_detail.png}
    \label{fig:bc111}
  }\\
  %
  \subfloat[split $\langle110\rangle$, -2.214 eV ]{
    ...
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/split-110-modelled2/stdrelax-short/vmd_detail.png}
  ...
  \subfloat[split $\langle110\rangle$, -2.215 eV]{
    %\includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/split-110-from-md/vmd_detail2.png}
    %\includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/split-110-from-md/stdrelax-short/vmd_detail2.png}
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/split-110-modelled/stdrelax-short/vmd_detail2.png}
    \label{fig:split110}
  }
  %
  ...
  \subfloat[not split $\langle110\rangle$, -2.384 eV]{
    %\includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/split-110-from-md/vmd_detail2.png}
    %\includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/split-110-from-md/stdrelax-short/vmd_detail2.png}
    \includegraphics[width=4.3cm]{../notur/hipersol/si-pi/si64/test_structures/split-110-from-md/stdrelax-strange/vmd_detail3.png}
    \label{fig:split110w}
  }
  %
