...
The left part of figure \label{fig:kpointdensity} shows the energy bands sampled at 17 k points between $-\pi/a$ and $\pi/a$. 
...
\begin{figure}[htbp]
  ...
  \end{center}
  \caption{
     Total energy and pressure as a function of varying the lattice parameter $a$ of a cubic unit cell (Si8).
     For the Si64 cell, the lattice parameter is $2a$, and the energy plotted is the cube root of the total energy,
