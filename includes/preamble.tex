...
% Enables the float [H] option which specifies that a floating object is inserted HERE! 
% The better would be if this package could be avoided... let's see
\usepackage{float}  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% BIBLIOGRAPHY :
\usepackage[safeinputenc,backend=biber,hyperref=true,sorting=none,style=nature]{biblatex} % or style=numeric?
